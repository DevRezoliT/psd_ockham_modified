...
If you plan to build the project manually using the provided .bat (Windows) or .sh (Unix/macOS) scripts, please ensure that the required build tools are installed and properly configured on your system.
